...
Be sure to check to use the [Things theme](https://github.com/colineckert/obsidian-things) or [Minimal theme](https://github.com/kepano/obsidian-minimal) or [AnuPpuccin theme](https://github.com/AnubisNekhet/AnuPpuccin)in the settings.
